...
import {
    BiHomeAlt, BiUser, BiBook, BiCalendarCheck, BiTime, BiGroup,
    BiBarChartAlt2, BiMessageDetail, BiLogOut, BiX, BiChevronDown, BiChevronRight, BiPencil
} from "react-icons/bi";
...
const TeacherSidebar = ({ collapsed, mobileOpen, handleDrawerToggle }) => {
